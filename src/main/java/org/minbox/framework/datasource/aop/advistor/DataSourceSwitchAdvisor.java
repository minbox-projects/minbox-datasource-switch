package org.minbox.framework.datasource.aop.advistor;
 ...
 * @author 恒宇少年
 */
public class DataSourceSwitchAdvisor extends AbstractPointcutAdvisor implements BeanFactoryAware {
    /**
     * Method Aspect Implementation
     *
     * @see DataSourceSwitchAnnotationInterceptor
     */
     ...
     *
     * @param apiBootDataSourceSwitchAnnotationInterceptor {@link DataSourceSwitchAnnotationInterceptor}
     */
    public DataSourceSwitchAdvisor(DataSourceSwitchAnnotationInterceptor apiBootDataSourceSwitchAnnotationInterceptor) {
